...
function Showconfetti(){
    ...
    ///VerletExpressJS
    VX.initialize( "2d", "canvas", "canvasMap", canvasWidth, canvasHeight );
    ...
    ///colors
    var backgroundColor = "rgb(17 17 17 / 0%)";
    ...
    document.getElementById("canvasMap").style.background = backgroundColor;
